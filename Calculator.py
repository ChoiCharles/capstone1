...
UI_diagram = "./diagramviewer/diagramviewer.ui"
class diagram(QDialog):
    ...
    def label_show(self):
        ...
        if type == "P-h diagram":
            ...
            if fluid == "R22" :
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/phR22.png")
                
            elif fluid == "R12":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/phR12.png")
            elif fluid == "R134a":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/phR134a.png")
            elif fluid == "R410a":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/phR410a.png")
            elif fluid == "water":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/phwater.png")
            time.sleep(1)               
            ...
            if fluid == "R22" :
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/TsR22.png")
                
            elif fluid == "R12":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/TsR12.png")
            elif fluid == "R134a":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/TsR134a.png")
            elif fluid == "R410a":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/TsR410a.png")
            elif fluid == "water":
                label = QLabel(self)
                pixmap = QPixmap("./diagramviewer/Tswater.png")
            time.sleep(1)   
            self.label.setPixmap(pixmap)            
            ...
            label = QLabel(self)
            pixmap = QPixmap("./diagramviewer/Psychro.png")
            self.label.setPixmap(pixmap)             

        
UI_Properties = "./ui/Properties.ui"
...
UI_Dimensionless = "./ui/Dimensionless_Calc.ui"
...
UI_Nu_ex_plate = './ui/external_flow_plate.ui'
...
UI_Nu_ex_cylinder = './ui/external_flow_cylinder.ui'
...
UI_Nu_ex_sphere = './ui/external_flow_sphere.ui'
...
UI_Hilpert_nd = './ui/Hilpert_nd.ui'
...
UI_Nu_in_thermal_entry = './ui/thermal_entry.ui'        
...
UI_Nu_in_combined_entry = './ui/combined_entry.ui'
...
UI_Nu_in_Dittus_Boelter = './ui/Dittus_Boelter.ui'
...
UI_Nu_in_Siedr = './ui/Sieder_Tate.ui'
...
UI_fc_vertical_plate_nd = "./ui/fc_vertical_plate_nd.ui"
...
UI_fc_plate_horizontal = "./ui/fc_plate_horizontal.ui"
...
UI_fc_plate_horizontal1_nd = "./ui/fc_plate_horizontal1_nd.ui"
...
UI_fc_plate_horizontal2_nd = "./ui/fc_plate_horizontal2_nd.ui"
...
UI_fc_horizontal_cylinder_nd = "./ui/fc_horizontal_cylinder_nd.ui"
...
UI_fc_sphere_nd = "./ui/fc_sphere_nd.ui"
...
UI_fc_horizontal_enclosure = "./ui/fc_horizontal_enclosure.ui"
...
UI_fc_vertical_cavity = "./ui/fc_vertical_cavity.ui"
...
UI_fc_concentric_cylinder = "./ui/fc_concentric_cylinder.ui"
...
UI_fc_concentric_sphere = "./ui/fc_concentric_sphere.ui"
...
UI_fc_tilted_cavity = "./ui/fc_tilted_cavity.ui"
